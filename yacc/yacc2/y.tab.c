...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    MUL = 261,                     /* MUL  */
    DIV = 262,                     /* DIV  */
    LEFT_BRA = 263,                /* LEFT_BRA  */
    RIGHT_BRA = 264,               /* RIGHT_BRA  */
    UMINUS = 265                   /* UMINUS  */
  };
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MUL = 6,                        /* MUL  */
  YYSYMBOL_DIV = 7,                        /* DIV  */
  YYSYMBOL_LEFT_BRA = 8,                   /* LEFT_BRA  */
  YYSYMBOL_RIGHT_BRA = 9,                  /* RIGHT_BRA  */
...
static const char *const yytname[] =
{
  ...
  "MUL", "DIV", "LEFT_BRA", "RIGHT_BRA", "UMINUS", "';'", "$accept",
